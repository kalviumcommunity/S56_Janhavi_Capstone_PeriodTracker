  ...
  return (
    <>
      ...
      <div className="header">
        <div className="image">
          <img src={image} width={830} alt="calendar" />
        </div>
      ...
      <div className="aboutus">
        ...
        <div className="text">
          <p>
            The website is a special tool made just for women. It helps them
            keep track of their menstrual cycle. The website also helps women
            plan their trips and decide where to go based on which part of their
            menstrual cycle they're in. Women can enjoy their travels more and
            feel comfortable throughout. The tracker part of the website is like
            a calendar that remembers each woman's cycle, so they don't have to.
            It sends reminders before important phases start, making it easier
            to plan.{" "}
          </p>
        </div>
      </div>
